...
INSERT INTO "new_Gift" ("amount", "createdAt", "currency", "id", "message", "otpExpiresAt", "otpHash", "recipientId", "senderId", "status", "template", "updatedAt") SELECT "amount", "createdAt", "currency", "id", "message", "otpExpiresAt", "otpHash", "recipientId", "senderId", "status", "template", "updatedAt" FROM "Gift";
DROP TABLE "Gift";
